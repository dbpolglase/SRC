...
/* =========================================================
 *  Example of use of multicast.
 *  
 *  Register the servers in a multicast IP (224.0.0.3). 
 *  
 * ========================================================== */
int main()
{
 /*
  *  Create socket for  multicast ip (224.0.0.3), port 3490 y 3491  
  *  indicate multicast.
  */
  SRC_Open("224.0.0.3","3490",1);
  SRC_Open("224.0.0.3","3491",1);
